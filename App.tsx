            ...
            <div className="space-y-4">
                ...
                <>
                  ...
                  <div>
                    ...
                    <input 
                      ...
                      type="tel" 
                      className={`w-full px-4 py-2 rounded-lg border outline-none focus:ring-2 ${authPhone.length > 0 && !isPhoneValid ? 'border-rose-400 focus:ring-rose-200' : 'border-slate-200 focus:ring-indigo-500'}`} 
                      required 
                    />
                    {authPhone.length > 0 && !isPhoneValid && (
                      <p className="text-[10px] text-rose-500 mt-1 font-semibold italic animate-in fade-in slide-in-from-top-1">Warning: Phone number must be exactly 10 digits.</p>
                    )}
                  </div>
                </>
              )}
              <div>
                ...
                <input 
                  ...
                  type="email" 
                  className={`w-full px-4 py-2 rounded-lg border outline-none focus:ring-2 ${authEmail.length > 0 && !isEmailValid ? 'border-rose-400 focus:ring-rose-200' : 'border-slate-200 focus:ring-indigo-500'}`} 
                  required 
                />
                {authEmail.length > 0 && !isEmailValid && (
                  <p className="text-[10px] text-rose-500 mt-1 font-semibold italic animate-in fade-in slide-in-from-top-1">Invalid Gmail address. Must end with @gmail.com</p>
                )}
                {!isSignup && loginAccountError && (
                  <p className="text-[10px] text-rose-500 mt-1 font-bold animate-in fade-in slide-in-from-top-1 uppercase tracking-wider">Account doesn't exist</p>
                )}
                {isSignup && signupAccountError && (
                  <p className="text-[10px] text-rose-500 mt-1 font-bold animate-in fade-in slide-in-from-top-1 italic">Account already exists with this mail</p>
                )}
              </div>
              <div>
                ...
                <input 
                  ...
                  type="password" 
                  className={`w-full px-4 py-2 rounded-lg border outline-none focus:ring-2 ${authPassword.length > 0 && !isPasswordValid ? 'border-rose-400 focus:ring-rose-200' : 'border-slate-200 focus:ring-indigo-500'}`} 
                  required 
                />
                {authPassword.length > 0 && !isPasswordValid && (
                   <p className="text-[10px] text-rose-500 mt-1 font-semibold italic animate-in fade-in slide-in-from-top-1 text-right">Minimum 6 characters are required</p>
                )}
              </div>
