                            ...
                            <div className="flex items-center gap-8">
                               ...
                               <div className="flex gap-3">
                                  <button 
                                    ...
                                    className="px-7 py-3 bg-indigo-600 hover:bg-indigo-500 text-white text-[10px] font-black uppercase rounded-xl shadow-lg transition-all active:scale-95 flex items-center gap-2"
                                  >
          ...
          {view === 'payout_hist' && (
            <div className="space-y-8 animate-in fade-in duration-500 w-full max-w-6xl mx-auto px-4 py-8">
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                ...
                <div className="bg-[#0f172a] border border-white/5 rounded-full p-1.5 flex items-center shadow-2xl">
                  {(['ALL', WithdrawalStatus.APPROVED, WithdrawalStatus.PENDING, WithdrawalStatus.REJECTED] as const).map(tab => (
                    <button 
                      ...
                      className={`px-6 py-2.5 text-[10px] font-black uppercase tracking-widest rounded-full transition-all duration-300 ${
              ...
              <div className="bg-[#0b1222]/50 backdrop-blur-xl border border-white/5 rounded-[32px] overflow-hidden shadow-2xl">
                 <div className="px-10 py-6 grid grid-cols-4 border-b border-white/5 text-slate-500">
                 ...
                 <div className="divide-y divide-white/5">
                    {finalPayoutsLog.length > 0 ? (
                       finalPayoutsLog.map(w => {
                          const worker = workers.find(wr => wr.id === w.userId);
                          return (
                            <div key={w.id} className="px-10 py-7 grid grid-cols-4 items-center group hover:bg-white/[0.02] transition-all duration-300">
                               ...
                               <span className="text-lg font-black text-white text-center tracking-tight">{w.amount} Rs</span>
                               ...
                               <span className="text-sm font-bold text-slate-500 text-right tracking-tight">
