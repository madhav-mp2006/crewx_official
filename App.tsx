    ...
    try {
      ...
      reader.onloadend = async () => {
        ...
        img.onload = async () => {
          ...
          // Max dimension 512px for better QR recognition
          const MAX_DIM = 512;
          if (width > height) {
            if (width > MAX_DIM) {
          ...
          try {
            ...
            const aiPromise = ai.models.generateContent({
              ...
              contents: {
                parts: [
                  ...
                  { text: "Does this image contain a QR code? Answer 'YES' if it is a QR code (especially a UPI or payment QR) and 'NO' if it is any other type of image. Answer only 'YES' or 'NO'." }
                ]
              },
              config: {
            ...
            setQrWarningMessage("Validation failed. Please ensure you are uploading a clear UPI QR code image.");
          } finally {
