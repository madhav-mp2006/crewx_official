    ...
    try {
      ...
      reader.onloadend = async () => {
        ...
        img.onload = async () => {
          ...
          // Get compressed base64 with higher quality
          ...
          try {
            ...
            const aiPromise = ai.models.generateContent({
              ...
              contents: {
                parts: [
                  ...
                  { text: "Is this image a QR code? Respond with 'YES' if it is a QR code (like a UPI payment QR), otherwise 'NO'. Answer only 'YES' or 'NO'." }
                ]
              },
              config: {
            ...
            if (result === 'YES' || result.includes('YES')) {
              // Only save if it's a valid QR code
              ...
              setQrWarningMessage("Please upload a UPI QR code image. This is compulsory for receiving payments.");
            }
          } catch (aiErr: any) {
            console.error("Validation Error:", aiErr);
            if (aiErr.message === "AI Timeout") {
              setQrWarningMessage("Validation timed out. Please ensure you have a stable connection and try again.");
            } else {
              setQrWarningMessage("Validation service is currently busy. Please try again in a few seconds.");
            }
          } finally {
