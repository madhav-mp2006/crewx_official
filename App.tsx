      ...
      reader.onloadend = async () => {
        ...
        img.onload = async () => {
          ...
          try {
            ...
            // If AI fails, we might want to be lenient or show a specific error
            setQrWarningMessage("Validation service is busy. Please try again or ensure the image is clear.");
          } finally {
